  ...
  return (
    <>
      ...
      <div className="mt-6 leading-relaxed text-slate-800">
        Кулинарная встреча с Александрой Пеле — нутрициологом из Сибири, ценителем вкуса и натуральных продуктов. <br> Это не
        мастер-класс — это встреча ценителей. <br> Готовим цветные сибирские{" "}
